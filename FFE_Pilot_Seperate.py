...
conditions=[
    {"label":"Seperate",'startVal': .1, "FC":0.1, "nReversals":1, "stepType":'log', "stepSizes":0.1, "nUp":nup, "nDown":ndown, "nTrials":nReal*nBlocks, "minVal":0, "maxVal":.1},
...
#Null conditions. Are identical, except some (or all) lines do not get drawn
    ...
    #C_null shapes
    {"label":"Seperate_null",'startVal': .1, "FC":0.1, "nReversals":1, "stepType":'log', "stepSizes":0.1, "nUp":nup, "nDown":ndown, "nTrials":nReal*nBlocks, "minVal":0, "maxVal":.1},
...
condition_counters = [
    # Exp
    [{"label":"Seperate",'startVal': .1, "FC":0.1, "nReversals":1, "stepType":'log', "stepSizes":0.1, "nUp":nup, "nDown":ndown, "nTrials":nReal*nBlocks, "minVal":0, "maxVal":.1}, 1, nReal*nBlocks],
    # Null
    # C
    [{"label":"Seperate_null",'startVal': .1, "FC":0.1, "nReversals":1, "stepType":'log', "stepSizes":0.1, "nUp":nup, "nDown":ndown, "nTrials":nReal*nBlocks, "minVal":0, "maxVal":.1}, 1, nNull*nBlocks],
]
